...
public class ScoreboardCustomizer extends Module {
    public ScoreboardCustomizer() {
        super("ScoreboardCustomizer", Category.HUD);
        addSetting(new BoolSetting("HideScoreboard", true));
        addSetting(new BoolSetting("CustomText", true));
    }
