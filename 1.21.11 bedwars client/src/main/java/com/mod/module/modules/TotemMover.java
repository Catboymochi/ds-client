...
public class TotemMover extends Module {
    public TotemMover() {
        super("TotemMover", Category.INVENTORY);
        addSetting(new BoolSetting("AutoMove", true));
        addSetting(new BoolSetting("OnlyWhenInInventory", true));
    }
